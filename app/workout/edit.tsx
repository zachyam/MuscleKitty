...
export default function EditWorkoutScreen() {
  ...
  const loadWorkout = async (workoutId: string) => {
    setLoading(true);
    const workout = await WorkoutService.getFormattedWorkoutById(workoutId);
    if (workout) {
  ...
  const handleSave = async () => {
    ...
    const existingWorkout = await WorkoutService.getFormattedWorkoutById(id as string);
    ...
    await WorkoutService.saveFormattedWorkout(updatedWorkout);
    ...
    Alert.alert('Delete Workout Plan', 'Are you sure? This cannot be undone.', [
      { text: 'Cancel', style: 'cancel' },
      {
        text: 'Delete', style: 'destructive', onPress: async () => {
          await WorkoutService.deleteWorkoutPlan(id as string);
