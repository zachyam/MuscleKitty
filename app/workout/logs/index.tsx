...
export default function WorkoutLogScreen() {
  ...
  const loadWorkoutLog = async (logId: string) => {
    ...
    try {
      ...
      const exists = await WorkoutService.checkIfLogExists(logId);
      ...
      const foundLog = await WorkoutService.getFormattedWorkoutLogById(logId);
    ...
    Alert.alert(
      ...
      [
        ...
        { 
          ...
          style: 'destructive',
          onPress: async () => {
            await WorkoutService.deleteWorkoutLog(id as string);
            router.back();
          }
        }
      ]
